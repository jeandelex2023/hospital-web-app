<%-- 
    Document   : Vue_listeConsultation1
    Created on : 9 févr. 2018, 11:56:30
    Author     : Delex
--%>
  ...
  <jsp:include page="header_liste.jsp"></jsp:include>
        ...
        function modifier_matie(nbmax) {
            ...
            if (exist > 1)
                ...
                document.location = "Form_modif_consultation.jsp?code=" + ident;
            }
        }
    ...
    <body class="no-skin">
          ...
          <form id="form1" name="form1" method="post" action="">
                 <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                     <thead>
                        <tr>
                         <th>Ordre par numéro</th>
                         <th>cons_nomPatient</th>
                         <th>cons_nomMedecin</th>
                         <th>cons_montant</th>
                         <th class="center">
		         <label class="pos-rel">
			 ...
			 <span class="lbl"></span>										</label>
                      ...
                      <tbody>
                       <% while (res.next()) {%>
                       <tr>
                          <td><%=res.getString("com_identifiant")%>
                              <input type="hidden" name="id<%=i%>" value="<%=res.getString("com_identifiant")%>"/>
                          </td>
                          <td><%=res.getString("cons_nomPatient")%></td>
                          <td><%=res.getString("cons_nomMedecin")%></td>
