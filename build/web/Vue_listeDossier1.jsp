<%-- 
    Document   : Vue_listeDossier1
    Created on : 14 févr. 2018, 10:52:44
    Author     : Delex
--%>
...
<html>
    ...
    <jsp:useBean id="gestionDs" scope="session" class="gestion.GestionDossier" />
    <%
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-header">
                        Resultat pour "Les dernières enregistrements DOSSIER"
                    </div>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Mere</th>
                                        <th class="hidden-480">Vaccine</th>

                                        <th>
                                            <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                            Historique Medicale
                                        </th>
                                        <th class="hidden-480">Date de Naissance</th>
                                        <th class="hidden-480">Sexe</th>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-480"><%=res.getString("dos_vaccine")%></td>
                                    <td><%=res.getString("dos_medicaleHistorique")%></td>
                                    <td class="hidden-480"><%=res.getString("dos_dateNaissance")%></td>
                                    <td class="hidden-480"><%=res.getString("dos_sexe")%></td>
                                </tr>
                                <%i++;%>
                                <%}%>
                            </tbody>
