...
<html>
    <script language="javascript">
            function supprimer_matiere(nbmax) {
                ...
                if (exist == 0)
                    ...
                    if (confirm('Voullez vous supprimer vraiement ces enregistrements?'))
                        document.location = "delete_consom.jsp?nbsuppr=" + exist + ident;
            }
            ...
            function modifier_matiere(nbmax) {
                ...
                if (exist > 1)
                    ...
                    document.location = "form_modif_cons.jsp?code=" + ident;
                }
            }
            function accueil(){
    ...
    <div id="menu_c">
        <p>Vous &ecirc;tes ici : <a href="javascript:accueil()">Accueil</a> > <a href="javascript:comd()">Consommation</a> > Mis à jour</p>
        <form id="form1" name="form1" method="post" action="">
            <div align="center">
                <br><div align="center"><font  size="2"><strong><font size="3">LISTE des CONSOMMATIONS </font></strong></font></div>
                    <br>
            ...
            <jsp:useBean id="cons" scope="session" class="action.classe.classeConsommation">
