<%-- 
    Document   : Vue_listeAnalyse
    Created on : 16 févr. 2018, 11:22:27
    Author     : Delex
--%>
...
<html>
    <script>
        if (!confirm("Es-tu certain de vouloir rediriger vers un autre page ? Clique sur OK pour continuer ou Annuler pour retourner à la page"))
            history.go(-1);
    </script>
    <jsp:include page="header_liste.jsp"></jsp:include>
        <script lang="javascript">
            ...
            function retour_Form_analyse() {

                document.location = "CreationAnalyse.jsp";
            }
            ;
        </script>
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small>
                                ...
                                <a href="#" onclick="javascript:retour_Form_analyse();">ANALYSE</a>
                            </small>
                            <small>
                                <i class="ace-icon fa fa-angle-double-right"></i>
                                LISTES
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                </div> <!-- FARA E PAGE CONTENT BEGINS-->                   
                                <!-- FARA Y NAVBAR -->
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="table-header">
                                            Resultat pour "Les dernières enregistrements ANALYSE ET RESULTAT"
                                        </div>
                                        <div>    
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>anal_numFacture</th>
                                                            <th>anal_idLaboratoire</th>
                                                            <th>anal_date</th>
                                                            <th>res_resultatObtenir</th>

                                                            <th class="hidden-480">anal_nomPrenom</th>
                                                            <th class="hidden-480">anal_agePatient</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#"><%=res.getString("anal_numFacture")%><input type="hidden" name="id<%=i%>" value="<%=res.getString("anal_numFacture")%>"/></a>
                                                            </td>
                                                            <td><%=res.getString("anal_idLaboratoire")%></td>
                                                            <td><%=res.getString("anal_date")%></td>
                                                            <td><%=res.getString("res_resultatObtenir")%></td>

                                                            <td class="hidden-480"><%=res.getString("anal_nomPrenom")%></td>
                                                            <td class="hidden-480"><%=res.getString("anal_agePatient")%></td>
                                                            <td><%=res.getString("anal_numTelpatient")%></td>
