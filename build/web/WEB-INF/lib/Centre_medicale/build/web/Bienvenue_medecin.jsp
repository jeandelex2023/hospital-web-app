<%-- 
    Document   : Bienvenue_medecin
    Created on : 12 févr. 2018, 18:38:19
    Author     : Delex
--%>
...
<html>
    <head>
        ...
        <meta name="description" content="Application de memoire L3" />
    ...
    <body class="no-skin" onload='display_ct()'>
                ...
                <ul class="nav nav-list">
                        ...
                        <ul class="submenu">
                            <li class="">
                                ...
                                <ul class="submenu">
                                    <li class="">
                                        <a href="Form_accueil.jsp">
                                            <i class="menu-icon fa fa-plus red"></i>
                                            Médecin
                                        </a>
                            ...
                            <li class="">
                                ...
                                <ul class="submenu">
                                    <li class="">
                                        <a href="Form_accueil.jsp">
                                            <i class="menu-icon fa fa-eye red"></i>
                                            Médecin
                                        </a>
                                    ...
                                    <li class="">
                                        ...
                                        <ul class="submenu">
                                            <li class="">
                                                <a href="Form_accueil.jsp">
                                                    <i class="menu-icon fa fa-pencil red"></i>
                                                    Médecin
                                                </a>
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="">
                                <a href="CreationConsultation.jsp">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="Form_accueil.jsp">Accueil</a>
                            </li>
                        ...
                        <div class="page-header">
                            <h1>
                                ...
                                <small>
                                    ...
                                    page d'accueil d'administrateur acces Medecin
                                </small>
        ...
        <div class="fixed-action-btn vertocal">
            ...
            <ul>
                ...
                <li><a class="btn-floating green tooltipped" data-position="left" data-delay="50" data-tooltip="Dossier..........." href="Vue_listeAnalyse.jsp"><i class="material-icons">local_pharmacy</i></a></li>
                <li><a class="btn-floating blue tooltipped" data-position="left" data-delay="50" data-tooltip="Consultation..." href="Vue_listeConsultation.jsp"><i class="material-icons">attach_money</i></a></li>
            </ul>
        </div>
