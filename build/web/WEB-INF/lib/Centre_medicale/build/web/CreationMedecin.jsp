        ...
        <body class="no-skin">
                ...
                <div class="navbar-container" id="navbar-container">
                    <div class="navbar-header pull-left">
                        ...
                        <button class="pull-right navbar-toggle navbar-toggle-img collapsed" type="button" data-toggle="collapse" data-target=".navbar-buttons,.navbar-menu">
                            ...
                            <img src="assets/avatars/user.jpg" alt="Delex Photo" />
                        </button>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <h4 class="white-opaque">
                                        ...
                                        <a href="#modal-table" role="button"  data-toggle="modal">Ouvrir le Formulaire des enregistrements!</a>
                                    </h4>                   
            ...
            <div class="fixed-action-btn vertocal">
                ...
                <ul>
                    ...
                    <li><a class="btn-floating teal tooltipped" data-position="left" data-delay="50" data-tooltip="Liste de recherche multi option" href="Vue_listeMedecin.jsp"><i class="material-icons">search</i></a></li>
                    <li><a class="btn-floating teal tooltipped" data-position="left" data-delay="50" data-tooltip="Liste d'import et export d'option" href="Vue_listeMedecin.jsp"><i class="material-icons">import_export</i></a></li>
                    <li><a class="btn-floating teal tooltipped" data-position="left" data-delay="50" data-tooltip="Liste de medecin version imprimmable" href="Vue_listeMedecin.jsp"><i class="material-icons">print</i></a></li>
                    <li><a class="btn-floating teal tooltipped" data-position="left" data-delay="50" data-tooltip="Liste de mis à jour et sauvegarde" href="Vue_listeMedecin1.jsp"><i class="material-icons">update</i></a></li>
                </ul>
            </div>
