<%-- 
    ...
    Created on : 12 févr. 2018, 16:33:06
    Author     : Delex
--%>
            ...
            function supprimer_mati(nbmax) {
                ...
                if (exist == 0)
                    ...
                    if (confirm('Si vous allez supprimer cet élement, vous risque de perdre son contenu!!\n \n \f NB: Effectuer pour\t [ OK ou ANNULER ]:\n \n \f -OK :: Pour éliminer cet élement! \n \n \f - Annuler :: Pour garder encore cet élement!'))
                        document.location = "Supprimer_listePatient.jsp?nbsuppr=" + exist + ident;
            }
            ...
            function modifier_matie(nbmax) {
                ...
                if (exist > 1)
                    ...
                    if (confirm('Vous êtes entrain de mêtre à jour une liste qui vient d/être sélectionner!! \n \n \f NB: Apuiez sur \t [ OK ou ANNULER ]:\n \n \f -OK :: Pour effectuer le changement ! \n \n \f - Annuler :: Pour ne pas changer !'))
                        document.location = "Form_modif_patient.jsp?code=" + ident;
                }
            }
                ...
                <div class="page-header">
                    <h1>
                        ...
                        <small>
                            ...
                            <a href='CreationPatient.jsp'>Patient </a><i class="ace-icon fa fa-angle-double-right"></i> Liste
                        </small>
                    </h1>
                </div><!-- /.page-header -->
                <div class="container">
                                ...
                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>pat_numero</th>
                                            <th>pat_nomPrenom</th>
                                            <th>pat_dateNaissance</th>
                                            <th>pat_sexe</th>
                                            <th>pat_domicile</th>
                                            <th>pat_nationalite</th>
                                            <th>pat_contact</th>
                                            <th class="center">
                                                <label class="pos-rel">
                                    ...
                                    <tbody>
                                        <% while (res.next()) {%>
                                        <tr>
                                            <td><%=res.getString("pat_numero")%>
                                                <input type="hidden" name="id<%=i%>" value="<%=res.getString("pat_numero")%>"/>
                                            </td>
                                            <td><%=res.getString("pat_nomPrenom")%></td>
                                            <td><%=res.getString("pat_dateNaissance")%></td>
                                            <td><%=res.getString("pat_sexe")%> </td> 
                                            <td><%=res.getString("pat_domicile")%> </td> 
                                            <td><%=res.getString("pat_nationalite")%> </td> 
