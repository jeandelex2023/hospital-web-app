<%-- 
    Document   : Vue_listeRendeVous
    Created on : 9 févr. 2018, 22:33:43
    Author     : Delex
--%>
...
<html>
    ...
    <jsp:useBean id="gestionRendre" scope="session" class="gestion.GestionRende_vous" />
    <%
                ...
                <div class="page-header">
                    <h1>
                        ...
                        <small>
                            ...
                            <a href='CreationRendeVous.jsp'>Rendez-Vous </a><i class="ace-icon fa fa-angle-double-right"></i> Liste
                        </small>
                    </h1>
                </div><!-- /.page-header -->
                <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-header">
                        Resultat pour "Les dernières enregistrements RENDEZ-VOUS"
                    </div>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Ordre d'identité</th>
                                        <th>
                                            <i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
                                            Date du rendez-vous
                                        </th>
                                        <th class="hidden-480">Docteur concerné</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#"><%=res.getString("automatique")%><input type="hidden" name="id<%=i%>" value="<%=res.getString("automatique")%>"/></a>
                                    </td>
                                    <td><%=res.getString("rend_date")%></td>
                                    <td class="hidden-480"><%=res.getString("rend_docConcerne")%></td>
                                    <td><%=res.getString("rend_patNumero")%></td>

                                    <td class="hidden-480">
                                        <span class="label label-sm label-warning">En attente</span>
                                    </td>
