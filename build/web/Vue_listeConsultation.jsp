<%-- 
    Document   : Vue_listeConsultation
    Created on : 9 févr. 2018, 09:01:58
    Author     : Delex
--%>
...
<html>
  <jsp:include page="header_liste.jsp"></jsp:include>
    ...
    <jsp:useBean id="gestionConsultation" scope="session" class="gestion.GestionConsultation" />
    <%
					...
					<tr>
						...
						<label class="pos-rel">
							...
							<span class="lbl"></span>
														...
														<th>Ordre numérique</th>
														<th>Nom du personne</th>
														<th class="hidden-480">Nom du Médecin</th>
                                                ...
                                                <% while (res.next()) {%>
													<tr>
														...
														<td>
															<a href="#"><%=res.getString("com_identifiant")%><input type="hidden" name="id<%=i%>" value="<%=res.getString("com_identifiant")%>"/></a>
														</td>
														<td><%=res.getString("cons_nomPatient")%></td>
														<td class="hidden-480"><%=res.getString("cons_nomMedecin")%></td>
														<td><%=res.getString("cons_montant")%></td>

														<td class="hidden-480">
															<span class="label label-sm label-warning">Payer</span>
														</td>
