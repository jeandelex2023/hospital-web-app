...
public final class Vue_005flistePatient1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        document.location = \"Supprimer_listePatient.jsp?nbsuppr=\" + exist + ident;\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("                        document.location = \"Form_modif_patient.jsp?code=\" + ident;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("                    <thead>\n");
      out.write("                        <tr>\n");
      out.write("                            <th>anal_numFacture</th>\n");
      out.write("                            <th>anal_idLaboratoire</th>\n");
      out.write("                            <th>anal_nomPrenom</th>\n");
      out.write("                            <th>anal_rc</th>\n");
      out.write("                            <th>anal_date</th>\n");
      out.write("                            <th>anal_priseCharge</th>\n");
      out.write("                            <th>anal_numTelpatient</th>\n");
      out.write("                            <th>anal_agePatient</th>\n");
      out.write("                            <th>anal_moisCor</th>\n");
      out.write("                            <th>anal_sexe</th>\n");
      out.write("                            <th>res_parametres</th>\n");
      out.write("                            <th>res_unite</th>\n");
      out.write("                            <th>res_resultatObtenir</th>\n");
 ...
 while (res.next()) {
      ...
      out.write("                    <tr>\n");
      out.write("                        <td>");
      out.print(res.getString("anal_numFacture"));
      out.write("\n");
      ...
      out.write("                        </td>\n");
      out.write("                        <td>");
      out.print(res.getString("anal_idLaboratoire"));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("anal_nomPrenom"));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("anal_rc"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("anal_date"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("anal_priseCharge"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("anal_numTelpatient"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("anal_agePatient"));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("anal_moisCor"));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("anal_sexe"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("res_parametres"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("res_unite"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("res_resultatObtenir"));
      out.write(" </td> \n");
      out.write("                        <td>\n");
      out.write("                            <label>\n");
