...
public final class Vue_005flisteConsultation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Ordre numérique</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Nom du personne</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th class=\"hidden-480\">Nom du Médecin</th>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>\n");
 ...
 while (res.next()) {
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"hidden-480\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"label label-sm label-warning\">Payer</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\n");
