...
public final class Vue_005flisteMedecin1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        document.location = \"Supprimer_listeMedecin.jsp?nbsuppr=\" + exist + ident;\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("                        document.location = \"Form_modif_medecin.jsp?code=\" + ident;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("\n");
      ...
      out.write("        </script>\n");
      out.write("    ");
      gestion.GestionMedecin gestionMdcin = null;
      synchronized (session) {
        gestionMdcin = (gestion.GestionMedecin) _jspx_page_context.getAttribute("gestionMdcin", PageContext.SESSION_SCOPE);
        if (gestionMdcin == null){
          gestionMdcin = new gestion.GestionMedecin();
          _jspx_page_context.setAttribute("gestionMdcin", gestionMdcin, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\n");
      out.write("    ");
      ...
      out.write("                            <th>Nationalite</th>\n");
      out.write("                            <th>Indice</th>\n");
      out.write("                            <th>Date debut Embauche</th>\n");
      out.write("                            <th>Date fin Embauche</th>\n");
      out.write("                            <th>Contact</th>\n");
      out.write("                            <th>Domicile</th>\n");
 ...
 while (res.next()) {
      ...
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("med_matricule"));
      out.write("\n");
      ...
      out.write("                        </td>\n");
      out.write("                        <td>");
      out.print(res.getString("med_nomPrenom"));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("med_sexe"));
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(res.getString("med_nationalite"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("med_indice"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("med_datebutEmbauche"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("med_datefinEmbauche"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("med_contact"));
      out.write(" </td> \n");
      out.write("                        <td>");
      out.print(res.getString("med_domicile"));
      out.write(" </td> \n");
      out.write("                        <td>\n");
      out.write("                            <label>\n");
