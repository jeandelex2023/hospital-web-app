...
<html>
    ...
    <body class="no-skin" onload='display_ct()';>
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Bienvenue : Jean Delex</li>
                        </ul><!-- /.breadcrumb -->
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="alert alert-block alert-success">
                                    ...
                                    Application web pour la gestion des patients du centre médicale<a href="#">&nbsp;&nbsp;Anosy!!</a>.
                                </div>
        ...
        <div class="fixed-action-btn vertocal">
            ...
            <ul>
                <li><a class="btn-floating red tooltipped" data-position="left" data-delay="50" data-tooltip="Patient......" href="Vue_listePatient.jsp"><i class="material-icons">book</i></a></li>
